...
class Text extends Widget {
  ...
  Size layout(Constraints constraints) {
    ...
    if (wordWrap && constraints.maxWidth > 0) {
      ...
      _measuredWidth = _lines!
          .fold(0, (int max, String l) => max > stringWidth(l) ? max : stringWidth(l));
    ...
    final h = _measuredHeight.clamp(constraints.minHeight, constraints.maxHeight);
